...
export const metadata: Metadata = {
  title: "StayNest - Find Perfect Rental Homes & Vacation Properties",
  description: "Discover unique rental properties and unforgettable stays. From cozy apartments to luxury villas, book your perfect home away from home with StayNest.",
  keywords: "vacation rentals, short term rentals, airbnb alternative, holiday homes, rental properties, accommodation booking",
  metadataBase: new URL("https://staynest.com"),
  alternates: {
    canonical: "https://staynest.com"
  },
  openGraph: {
    title: "StayNest - Find Perfect Rental Homes & Vacation Properties",
    description: "Discover unique rental properties and unforgettable stays. From cozy apartments to luxury villas, book your perfect home away from home.",
    siteName: "StayNest",
    images: [{
      url: "https://images.pexels.com/photos/210604/pexels-photo-210604.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Beautiful vacation rental home interior"
    }],
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "StayNest - Find Perfect Rental Homes",
    description: "Discover unique rental properties and unforgettable stays worldwide.",
    images: ["https://images.pexels.com/photos/210604/pexels-photo-210604.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
